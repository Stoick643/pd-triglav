...
class MockMessage:
    ...
    def __init__(self, subject: str, recipients: List[str], body: str = "", 
                 html: str = "", sender: str = "test@example.com"):
...
class MockEmailService:
    ...
    def send_trip_notification(self, recipients: List[str], trip_title: str, trip_date: str) -> bool:
...
def patch_flask_mail():
    ...
    mock_mail = MockMail()
    return ("flask_mail", type('MockFlaskMail', (), {
        'Mail': lambda app=None: mock_mail,
        'Message': MockMessage
    })())
