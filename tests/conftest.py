...
def test_users(app):
    ...
    with app.app_context():
        ...
        admin = User.create_user(
            email="admin@test.com", name="Admin User", password="adminpass", role=UserRole.ADMIN
        )
        ...
        member = User.create_user(
            email="member@test.com", name="Member User", password="memberpass", role=UserRole.MEMBER
        )
        member.approve()
        ...
        pending = User.create_user(
            email="pending@test.com", name="Pending User", password="pendingpass"
        )
...
def sample_historical_events(app):
    ...
    def _get_events():
        ...
        return {
            ...
            "alpine_discovery": HistoricalEvent.query.filter_by(
