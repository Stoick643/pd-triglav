...
class TestLLMService:
    ...
    def test_make_api_request_provider_error(self, llm_service, mock_provider_manager):
        ...
        mock_provider_manager.chat_completion_with_fallback.side_effect = LLMError(
            "Provider failed"
        )
    ...
    def test_generate_historical_event_success(
        self, mock_load_prompt, mock_api_request, llm_service
    ):
    ...
    @patch.object(LLMService, "_make_api_request")
    def test_generate_historical_event_people_string_conversion(
        self, mock_api_request, llm_service
    ):
    ...
    def test_test_connection_failure(self, llm_service, mock_provider_manager):
        ...
        mock_provider_manager.test_all_providers.return_value = {
            "moonshot": False,
            "deepseek": False,
        }
