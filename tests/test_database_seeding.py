    ...
    def test_seed_script_creates_test_users(self, app):
        ...
        with app.app_context():
            ...
            result = subprocess.run(
                [sys.executable, get_seed_script_path()], capture_output=True, text=True, env=env
            )
    ...
    def test_seed_users_have_correct_roles_and_data(self, app):
        ...
        with app.app_context():
            ...
            if User.query.count() == 0:
                ...
                env["DATABASE_URL"] = test_db_uri
                subprocess.run(
                    [sys.executable, get_seed_script_path()], capture_output=True, env=env
                )
        ...
        with app.app_context():
            ...
            for email in test_emails:
                ...
                assert user.check_password(
                    "password123"
                ), f"User {email} password verification failed"
