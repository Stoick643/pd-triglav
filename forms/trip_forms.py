...
class TripForm(FlaskForm):
    ...
    difficulty = SelectField(
        "Zahtevnost",
        validators=[DataRequired(message="Zahtevnost je obvezna.")],
        choices=[
...
class TripDiscussionForm(FlaskForm):
    ...
    message = TextAreaField(
        ...
        description="Dogovori za prevoz, srečanje, oprema, logistika...",
    )
...
class TripReportForm(FlaskForm):
    ...
    photos = MultipleFileField(
        ...
        validators=[
            Optional(),
            FileAllowed(
                ["jpg", "jpeg", "png", "gif"], message="Dovoljene so samo slike (JPG, PNG, GIF)."
            ),
    ...
    is_published = SelectField(
        ...
        choices=[("true", "Da, objavi poročilo"), ("false", "Ne, shrani kot osnutek")],
        default="true",
    )
    ...
    def validate_photos(self, field):
        ...
        if field.data:
            ...
            allowed_extensions = getattr(
                current_app.config, "ALLOWED_PHOTO_EXTENSIONS", {"jpg", "jpeg", "png", "gif"}
            )
                ...
                if file.filename:
                    ...
                    if file_size > max_photo_size:
                        ...
                        raise ValidationError(
                            f'Velikost slike "{file.filename}" presega {max_mb} MB.'
                        )
            ...
            if total_size > max_total:
                ...
                raise ValidationError(
                    f"Skupna velikost fotografij ({current_total_mb} MB) presega dovoljeno ({max_total_mb} MB)."
                )
...
class TripReportFilterForm(FlaskForm):
    ...
    featured_only = SelectField(
        "Prikaži",
        validators=[Optional()],
        choices=[("", "Vsa poročila"), ("featured", "Samo označena"), ("recent", "Najnovejša")],
    )
