    ...
    def test_connection(self) -> bool:
        ...
        try:
            messages = [
                ...
                {"role": "user", "content": 'Respond with JSON: {"status": "ok", "message": "test successful"}'}
            ]
...
class ProviderManager:
    ...
    def chat_completion_with_fallback(self, messages: List[Dict], use_case: str = 'historical', **kwargs) -> Dict:
        """
