...
def require_trip_leader(f):
    ...
    def decorated_function(*args, **kwargs):
        ...
        if not (current_user.role in [UserRole.TRIP_LEADER, UserRole.ADMIN]):
...
def dashboard():
    ...
    if current_user.role in [UserRole.TRIP_LEADER, UserRole.ADMIN]:
        ...
        return render_template('trips/leader_dashboard.html', 
                             led_trips=led_trips, 
        ...
        return render_template('trips/member_dashboard.html', 
                             my_participations=my_participations)
